...
export const ui = {
  'sr-latn': {
    ...
    'skills.react.description': 'Izgradnja modernih veb aplikacija sa React 19, Remix i Redux',
    ...
    'skills.angular.description': 'Izgradnja aplikacija za preduzeća sa Angular i TypeScript',
    'skills.astro.title': 'Astro',
    'skills.astro.description': 'Izgradnja brzih, sadržajima orijentisanih sajtova sa Astro',
    ...
    'work.experience.epages.period': 'Jan 2024 - Sadašnjost',
    ...
    'education.dci.bullet3': 'Git kontrola verzija i GitHub timski workflow',
    ...
    'about.intro.paragraph2':
      'Pre prelaska na veb razvoj, radio sam u Business Management-u nekoliko godina. Iako je to bilo interesantno, nešto je nedostajalo. 2020. godine prešao sam na programiranje, i ispalo je da je to bila jedna od mojih najboljih odluka. Postoji nešto duboko zadovoljavajuće u rešavanju problema kroz kod i gledanju kako funkcionalnosti oživljavaju.',
    ...
    'about.skills.paragraph2':
      'Build alati kao što su Webpack i Gulp, kontrola verzija sa Git i Web Accessibility standardi su svi deo alata. Van posla, uživam u eksperimentisanju sa Astro (ovaj sajt je izgrađen sa njim) i produbljivanju u accessibility najbolje prakse.',
    ...
    'about.contact.title': 'Stupite u kontakt',
    'about.contact.paragraph':
      'Ako želite da se povežemo o veb razvoju, React, TypeScript ili bilo čemu vezanom za izgradnju veba, slobodno me kontaktirajte. Najaktivniji sam na GitHub i LinkedIn.',
    ...
    'contact.email.note': 'Najbolji način da me kontaktirate. Obično odgovaram u roku od 24 sata.',
    ...
    'contact.responseTime.paragraph':
      'Proveravajuće email redovno i nastojim da odgovorim u roku od 24 sata. Za hitne stvari, LinkedIn poruke obično dobijaju brže odgovore. Imajte na umu da radim puno radno vreme, tako da odgovori mogu biti odloženi tokom zauzetih nedelja.',
    ...
    'meta.home.description':
      'JavaScript programer sa 5 godina iskustva u React, TypeScript, Astro i modernom web razvoju. Promenio karijeru i volim da rešavam probleme i učim nove tehnologije.',
    ...
    'meta.contact.description': 'Stupite u kontakt',
    ...
    'faq.react-experience.question': 'Koji je vaš trenutni tech stack?',
    ...
    'faq.testing.answer':
      'U ePages-u radim na dve glavne platforme: storefront prodavnice sa vizuelnim page editorom, i Commerce Cockpit, koji je merchant admin sistem sa preko 50 pogleda za upravljanje proizvodima, porudžbinama i korisnicima. Uglavnom React komponente, poslovna logika, API integracije, i osigurati da sve radi zajedno u monorepo-u.',
    ...
    'faq.location.question': 'Koje testne framework-e koristite?',
    'faq.location.answer':
  ...
  sr: {
    ...
    'skills.react.description': 'Изградња модерних веб апликација са React 19, Remix и Redux',
    'skills.typescript.title': 'TypeScript',
    'skills.typescript.description':
    ...
    'skills.angular.title': 'Angular',
    'skills.angular.description': 'Изградња апликација за предузећа са Angular и TypeScript',
    'skills.astro.title': 'Astro',
    'skills.astro.description': 'Изградња брзих, садржајима оријентисаних сајтова са Astro',
    ...
    'work.experience.epages.period': 'Јан 2024 - Садашњост',
    'work.experience.epages.bullet1':
    ...
    'education.dci.bullet3': 'Git контрола верзија и GitHub тимски workflow',
    ...
    'about.intro.paragraph2':
      'Пре преласка на веб развој, радио сам у Business Management-у неколико година. Иако је то било интересантно, нешто је недостајало. 2020. године прешао сам на програмирање, и испало је да је то била једна од мојих најбољих одлука. Постоји нешто дубоко задовољавајуће у решавању проблема кроз код и гледању како функционалности оживљавају.',
    'about.currentWork.title': 'На чему тренутно радим',
    'about.currentWork.paragraph1':
      'У ePages-у, радим на две главне платформе: продавнице за кориснике и Commerce Cockpit, admin систем за трговце. Stack је React 19, Remix, Redux и TypeScript, све у monorepo архитектури. Пишем јединичне тестове са Jest и E2E тестове са Cypress и Playwright да би ствари биле поуздане.',
    'about.currentWork.paragraph2':
      'Commerce Cockpit је свеобухватна admin платформа са преко 50 погледа за управљање производима, поруџбинама, корисницима и још много тога. Рад у monorepo-у са више међусобно повезаних пакета значи обратити пажњу на то како промене утичу на цео систем.',
    'about.experience.title': 'Позадина',
    'about.experience.paragraph1':
      'Пре ePages-а, радио сам као Frontend програмер у FxPro, fintech компанији, од 2022. до 2023. Фокус је био на trading платформама и финансијским алатима изграђеним са Angular и Svelte. Креирао сам landing странице, marketing microsites, email шаблоне за multilocale кампање и интерактивне калкулаторе интегрисане са Highcharts.',
    'about.experience.paragraph2':
    ...
    'about.skills.paragraph2':
      'Build алати као што су Webpack и Gulp, контрола верзија са Git и Web Accessibility стандарди су сви део алата. Ван посла, уживам у експериментисању са Astro (овај сајт је изграђен са њим) и продубљивању у accessibility најбоље праксе.',
    ...
    'about.contact.title': 'Ступите у контакт',
    'about.contact.paragraph':
      'Ако желите да се повежемо о веб развоју, React, TypeScript или било чему везаном за изградњу веба, слободно ме контактирајте. Најактивнији сам на GitHub и LinkedIn.',
    'about.contact.email': 'Email',
    'about.footerNote':
    ...
    'contact.email.title': 'Email',
    'contact.email.note': 'Најбољи начин да ме контактирате. Обично одговарам у року од 24 сата.',
    ...
    'contact.responseTime.paragraph':
      'Проверавајуће email редовно и настојим да одговорим у року од 24 сата. За хитне ствари, LinkedIn поруке обично добијају брже одговоре. Имајте на уму да радим пуно радно време, тако да одговори могу бити одложени током заузетих недеља.',
    ...
    'meta.home.description':
      'JavaScript програмер са 5 година искуства у React, TypeScript, Astro и модерном веб развоју. Променио каријеру и волим да решавам проблеме и учим нове технологије.',
    ...
    'meta.contact.description': 'Ступите у контакт',
    ...
    // Technical Skills Q&A
    'faq.react-experience.question': 'Који је ваш тренутни tech stack?',
    'faq.react-experience.answer':
    ...
    'faq.testing.answer':
      'У ePages-у радим на две главне платформе: storefront продавнице са визуелним page editor-ом, и Commerce Cockpit, који је merchant admin систем са преко 50 погледа за управљање производима, поруџбинама и корисницима. Углавном React компоненте, пословна логика, API интеграције, и осигурати да све ради заједно у monorepo-у.',
    ...
    // Collaboration & Networking Q&A
    'faq.location.question': 'Које тестне framework-е користите?',
    'faq.location.answer':
      'Користим Jest и React Testing Library за јединичне и интеграционе тестове, и Cypress и Playwright за E2E. У ePages-у, пишем тестове и за storefront и за Commerce Cockpit admin систем. Велики је део посла одржати ствари поузданим, посебно у monorepo-у где промене могу утицати на више пакета.',
